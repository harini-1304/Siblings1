...
function FacultyLogin() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Email was sent successfully - user must check inbox
      setResetMessage('✅ Password reset email sent! Check your inbox (including spam folder) for the reset link. The link expires in 30 minutes.');
      setResetEmail('');
