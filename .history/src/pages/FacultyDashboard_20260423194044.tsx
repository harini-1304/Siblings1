                  ...
                  <thead>
                    <tr>
                      ...
                      <th>
                        <div className="th-header">
                          <span>Branch</span>
                          <div className="filter-icon" title="Filter by branch">▼</div>
                        </div>
                      </th>
                      <th>
                        <div className="th-header">
                          <span>Section</span>
                          <div className="filter-icon" title="Filter by section">▼</div>
                        </div>
                      </th>
                      <th>
                        <div className="th-header">
                      ...
                      <th>
                        <div className="th-header">
                          ...
                          <div className="filter-icon" title="Filter by contacts">▼</div>
                        </div>
                      </th>
                      <th>Actions</th>
                    </tr>
