...
function FacultyLogin() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check if API returned a direct reset link (happens in development when email fails)
      if (response.resetLink) {
        setResetMessage('✅ Password reset link generated! Opening reset page...');
        setResetEmail('');
        
        // Open reset link directly in a new tab
        setTimeout(() => {
          window.open(response.resetLink, '_blank');
