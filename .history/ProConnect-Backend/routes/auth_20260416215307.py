...
def forgot_password():
    ...
    try:
        ...
        try:
            ...
            # Create email
            msg = MIMEMultipart()
            msg['From'] = os.getenv('SENDER_EMAIL', 'proconnect.psgitech@gmail.com')
            msg['To'] = email
            ...
            # Send email
            smtp_server = smtplib.SMTP(os.getenv('SMTP_SERVER', 'smtp.gmail.com'), 
                                       int(os.getenv('SMTP_PORT', 587)))
            smtp_server.starttls()
            smtp_server.login(
                os.getenv('SENDER_EMAIL', 'proconnect.psgitech@gmail.com'),
